...
idkyet <-
  ...
  labs(fill = 'Pitch Type',
       caption = "Average spin rate of deGrom's fastballs and sliders from the start of the season to his last game on July 7th",
       title = "deGrom's Average Spin Rate per Game")
idkyet
